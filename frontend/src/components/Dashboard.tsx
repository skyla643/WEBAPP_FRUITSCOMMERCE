...
const Dashboard: React.FC = () => {
  ...
  const defaultLatitude = -34.397; // Example latitude (Australia) - REPLACE WITH YOUR DESIRED LATITUDE
  const defaultLongitude = 150.644; // Example longitude (Australia) - REPLACE WITH YOUR DESIRED LONGITUDE
  const defaultZoom = 8; // Example zoom level - REPLACE WITH YOUR DESIRED ZOOM LEVEL
